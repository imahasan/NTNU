...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.group13.scheduling_requirements.schedulingRequirements.Course} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SchedulingRequirementsPackage.Literals.COURSE__NAME, true, false, false,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SchedulingRequirementsPackage.Literals.COURSE__CODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Course_coordinator_feature",
								"_UI_Course_type"),
						SchedulingRequirementsPackage.Literals.COURSE__COORDINATOR, true, false, true, null, null,
						null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulingRequirementsPackage.Literals.COURSE__SCHEDULINGREQUIREMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SchedulingRequirementsPackage.Literals.COURSE__SCHEDULINGREQUIREMENTS,
						SchedulingRequirementsFactory.eINSTANCE.createschedulingRequirements()));
	}
