...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.group13.scheduling_requirements.schedulingRequirements.Week} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WeekItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addWeekNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Week_weekNumber_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Week_weekNumber_feature", "_UI_Week_type"),
						SchedulingRequirementsPackage.Literals.WEEK__WEEK_NUMBER, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulingRequirementsPackage.Literals.WEEK__SLOT_REQUIREMENTS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Week_type") + " " + week.getWeekNumber();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SchedulingRequirementsPackage.Literals.WEEK__SLOT_REQUIREMENTS,
				SchedulingRequirementsFactory.eINSTANCE.createSlotRequirement()));
	}
