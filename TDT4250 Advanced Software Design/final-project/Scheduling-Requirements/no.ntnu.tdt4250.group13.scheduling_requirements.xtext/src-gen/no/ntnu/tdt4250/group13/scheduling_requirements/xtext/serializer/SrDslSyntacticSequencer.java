...
public class SrDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected SrDslGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (SrDslGrammarAccess) access;
	}
