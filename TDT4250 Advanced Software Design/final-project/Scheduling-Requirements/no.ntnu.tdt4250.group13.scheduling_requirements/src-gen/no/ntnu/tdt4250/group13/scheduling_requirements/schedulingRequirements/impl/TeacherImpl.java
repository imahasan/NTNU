 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.group13.scheduling_requirements.schedulingRequirements.impl.TeacherImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TeacherImpl extends MinimalEObjectImpl.Container implements Teacher {
	...
	protected EClass eStaticClass() {
		return SchedulingRequirementsPackage.Literals.TEACHER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulingRequirementsPackage.TEACHER__NAME, oldName,
					name));
	}
