...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.group13.timetable.Course} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						TimetablePackage.Literals.COURSE__NAME, true, false, false,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						TimetablePackage.Literals.COURSE__CODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Course_coordinator_feature",
								"_UI_Course_type"),
						TimetablePackage.Literals.COURSE__COORDINATOR, true, false, true, null, null, null));
	}
	...
	protected void addLecturerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Course_lecturer_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Course_lecturer_feature",
								"_UI_Course_type"),
						TimetablePackage.Literals.COURSE__LECTURER, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TimetablePackage.Literals.COURSE__COURSETIMETABLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TimetablePackage.Literals.COURSE__COURSETIMETABLE,
				TimetableFactory.eINSTANCE.createCourseTimetable()));
	}
