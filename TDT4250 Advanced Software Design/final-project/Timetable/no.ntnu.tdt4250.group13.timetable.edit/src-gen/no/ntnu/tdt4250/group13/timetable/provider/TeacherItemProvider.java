...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.group13.timetable.Teacher} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TeacherItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addSlotPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Teacher_slot_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Teacher_slot_feature", "_UI_Teacher_type"),
						TimetablePackage.Literals.TEACHER__SLOT, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Teacher_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Teacher_name_feature", "_UI_Teacher_type"),
						TimetablePackage.Literals.TEACHER__NAME, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case TimetablePackage.TEACHER__NAME:
