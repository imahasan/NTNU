 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.TeacherImpl#getSlot <em>Slot</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.TeacherImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TeacherImpl extends MinimalEObjectImpl.Container implements Teacher {
	...
	protected EClass eStaticClass() {
		return TimetablePackage.Literals.TEACHER;
	}
	...
	public EList<Slot> getSlot() {
		if (slot == null) {
			slot = new EObjectWithInverseResolvingEList.ManyInverse<Slot>(Slot.class, this,
					TimetablePackage.TEACHER__SLOT, TimetablePackage.SLOT__LECTURER);
		}
		return slot;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimetablePackage.TEACHER__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case TimetablePackage.TEACHER__SLOT:
