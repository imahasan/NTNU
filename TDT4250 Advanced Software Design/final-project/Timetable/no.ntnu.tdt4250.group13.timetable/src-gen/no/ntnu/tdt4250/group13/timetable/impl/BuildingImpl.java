 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.BuildingImpl#getName <em>Name</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.BuildingImpl#getRoom <em>Room</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BuildingImpl extends MinimalEObjectImpl.Container implements Building {
	...
	protected EClass eStaticClass() {
		return TimetablePackage.Literals.BUILDING;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimetablePackage.BUILDING__NAME, oldName, name));
	}
	...
	public EList<Room> getRoom() {
		if (room == null) {
			room = new EObjectContainmentEList<Room>(Room.class, this, TimetablePackage.BUILDING__ROOM);
		}
		return room;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case TimetablePackage.BUILDING__ROOM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TimetablePackage.BUILDING__NAME:
			return getName();
		case TimetablePackage.BUILDING__ROOM:
			return getRoom();
		}
