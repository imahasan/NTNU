 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.WeekImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.WeekImpl#getSlot <em>Slot</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeekImpl extends MinimalEObjectImpl.Container implements Week {
	...
	protected EClass eStaticClass() {
		return TimetablePackage.Literals.WEEK;
	}
	...
	public void setNumber(int newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimetablePackage.WEEK__NUMBER, oldNumber, number));
	}
	...
	public EList<Slot> getSlot() {
		if (slot == null) {
			slot = new EObjectContainmentEList<Slot>(Slot.class, this, TimetablePackage.WEEK__SLOT);
		}
		return slot;
	}
