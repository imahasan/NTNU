 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getDay <em>Day</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getRoom <em>Room</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getLecturer <em>Lecturer</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getWeek <em>Week</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getCourse <em>Course</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group13.timetable.impl.SlotImpl#getDate <em>Date</em>}</li>
 * </ul>
 *
 * @generated
 */
