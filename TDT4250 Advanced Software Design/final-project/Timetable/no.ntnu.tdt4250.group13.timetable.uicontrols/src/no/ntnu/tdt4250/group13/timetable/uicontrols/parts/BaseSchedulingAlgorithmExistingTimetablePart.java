...
public class BaseSchedulingAlgorithmExistingTimetablePart {
	
	public String inputFileNames = "";
	public String timetableName = "";
	public String outputFolderName = "";
	public Text inputFileNameText;
	public Text timetableNameText;
	...
	public void createComposite(Composite parent) {
		...
		// input configuration
		Label exitingTimetableLabel = new Label(parent, SWT.PUSH);
		exitingTimetableLabel.setText("Select existing timetable to modify:");
		Button existingTimetableButton = new Button(parent, SWT.PUSH);
		existingTimetableButton.setText("Select timetable file...");
		timetableNameText = new Text(parent, SWT.PUSH);
		timetableNameText.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		existingTimetableButton.addSelectionListener(new SelectionListener() {

			@Override
			public void widgetSelected(SelectionEvent e) {
				FileDialog dialog = new FileDialog(parent.getShell());
				timetableName = dialog.open();
				if (timetableName != "") {
					timetableNameText.setText(timetableName);
				}
			}
		...
		startAlgorithm.addSelectionListener(new SelectionListener() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				if (timetableName == "" || inputFileNames == "" || outputFolderName == "" || outputFileNameText.getText() == "") {
					errorText.setText("ERROR: at least one argument is missing");
				} else {
					String output = "--extend " + timetableName + " " + inputFileNames + outputFolderName + "/" + outputFileNameText.getText() + ".timetable";
